...
Quantum++ is a template-based header-only C++11 quantum computing library, using Eigen3 linear algebra library http://eigen.tuxfamily.org/. Copyright (c) 2013 - 2014 Vlad Gheorghiu (vgheorgh@gmail.com).
